...
def load_predictor(model_dir,
    ...
    infer_model = os.path.join(model_dir, 'bpe_simple_vocab_16e6.txt.gz')
...
class DataArguments:
    ...
    image_paths: list = field(
        ...
        metadata={
            "help": "image paths directory."
        },
    )
    audio_paths: list = field(
        default=[
