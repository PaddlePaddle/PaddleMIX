...
class ImageBindModel(ImageBindPretrainedModel):
    ...
    def _create_modality_heads(
        ...
        modality_heads[ModalityType.AUDIO] = paddle.nn.Sequential(
            ...
            SelectElement(index=0),
            paddle.nn.Linear(
                in_features=audio_embed_dim, out_features=out_embed_dim, bias_attr=False
            ),
        )
        modality_heads[ModalityType.DEPTH] = paddle.nn.Sequential(
            ...
            SelectElement(index=0),
            paddle.nn.Linear(
                in_features=depth_embed_dim, out_features=out_embed_dim, bias_attr=False
            ),
        )
        ...
        modality_heads[ModalityType.IMU] = paddle.nn.Sequential(
            ...
            paddle.nn.Linear(
                in_features=imu_embed_dim, out_features=out_embed_dim, bias_attr=False
            ),
        )
