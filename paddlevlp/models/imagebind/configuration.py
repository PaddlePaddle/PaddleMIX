...
class ImageBindConfig(PretrainedConfig):
    ...
    def __init__(
        self, text_config=None, vision_config=None, audio_config=None, depth_config=None, thermal_config=None, imu_config=None, projection_dim=512, logit_scale_init_value=2.6592, **kwargs
    ):
        kwargs["return_dict"] = kwargs.pop("return_dict", True)
        super().__init__(**kwargs)
