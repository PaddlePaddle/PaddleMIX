...
from paddlevlp.processors.blip_processing import Blip2Processor,BlipImageProcessor
...
class Predictor:
    def __init__(self, args):
        ...
        self.processor = BlipImageProcessor.from_pretrained(args.model_name_or_path)
    ...
    def run(self, image):
        ...
        input_handle1 = {input_names[0]:self.predictor.get_input_handle(input_names[0])}
