...
from .image_utils import (IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD,valid_images,get_preprocess_shape)
...
class SamProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        prompt = self.prompt_processor(self.original_size,
...
class SamImageProcessor(BaseImageProcessor):
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        input_image = [
                    self.apply_image(image) for image in images
                ]
        ...
        input_image_paddle = (input_image_paddle - paddle.to_tensor(self.image_mean).reshape([-1, 1, 1])) / paddle.to_tensor(self.image_std).reshape([-1, 1, 1])
