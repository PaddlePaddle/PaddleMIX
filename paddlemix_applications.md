...
11. [PaddleMIX的PPT生成器](https://aistudio.baidu.com/projectdetail/8545186)
    - 💻 类型：幻灯片生成
...
22. [国庆庆典：音乐与国庆辉煌交响](https://aistudio.baidu.com/projectdetail/8356701)
    - 🎹 类型：音乐生成
    - 🎺 功能：基于文本和照片的配乐生成
    - 🔥 热度：🔥
...
43. [PaddleMIX入门AIGC应用](https://aistudio.baidu.com/projectdetail/7583868)
    - 📟 类型：多模态生成
