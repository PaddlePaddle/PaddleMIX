...
class KDPM2AncestralDiscreteSchedulerTest(SchedulerCommonTest):
    ...
    def test_full_loop_device(self):
        ...
        assert abs(result_sum.item() - 13913.078125) < 1e-1
    ...
    def test_full_loop_with_noise(self):
        ...
        assert abs(result_sum.item() - 93087.140625) < 1e-2, f" expected result sum 93087.0312, but get {result_sum}"
        assert abs(result_mean.item() - 121.2072) < 5e-3, f" expected result mean 121.2071, but get {result_mean}"
