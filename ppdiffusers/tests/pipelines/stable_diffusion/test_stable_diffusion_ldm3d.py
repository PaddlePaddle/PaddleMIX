...
class StableDiffusionLDM3DPipelineFastTests(unittest.TestCase):
    ...
    def test_stable_diffusion_prompt_embeds(self):
        ...
        # print('rgb_slice_1.flatten() ', rgb_slice_1.flatten())
        # print('rgb_slice_2.flatten() ', rgb_slice_2.flatten())
    ...
    def test_stable_diffusion_negative_prompt(self):
        ...
        # print('rgb_slice.flatten() negative', rgb_slice.flatten())
        # print('depth_slice.flatten() negative', depth_slice.flatten())
