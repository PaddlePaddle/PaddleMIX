...
class KandinskyV22ControlnetPipelineIntegrationTests(unittest.TestCase):
    ...
    #         "kandinsky-community/kandinsky-2-2-prior", paddle_dtype="float16", from_diffusers=False, from_hf_hub=False
    #     )

    #     pipeline = KandinskyV22ControlnetPipeline.from_pretrained(
    #         "kandinsky-community/kandinsky-2-2-controlnet-depth", paddle_dtype="float16", from_diffusers=False, from_hf_hub=False
    #     )
