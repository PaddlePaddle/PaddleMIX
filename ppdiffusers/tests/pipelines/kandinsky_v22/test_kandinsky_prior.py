...
from ppdiffusers import KandinskyV22PriorPipeline, PriorTransformer, UnCLIPScheduler
...
class Dummies:
    ...
    def dummy_prior(self):
        ...
        out_83 = paddle.create_parameter(
...
class KandinskyV22PriorPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_kandinsky_prior(self):
        ...
        expected_slice = np.array([-0.0532, 1.712, 0.3656, -1.0852, -0.8946, -1.1756, 0.4348, 0.2482, 0.5146, -0.1156])
