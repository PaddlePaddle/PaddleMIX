...
class StableDiffusionXLPipelineFastTests(PipelineLatentTesterMixin, PipelineTesterMixin, SDXLOptionalComponentsTesterMixin, unittest.TestCase):
    ...
    def test_stable_diffusion_xl_euler(self):
        ...
        expected_slice = np.array([0.16128531, 0., 0.0498, 0.,0.,0.08472335, 0.26672202,0.,0.29921377])
    ...
    def test_stable_diffusion_xl_euler_lcm(self):
        ...
        assert image.shape == (1, 64, 64, 3)
        expected_slice = np.array([0.30508393, 0.2898788, 0.31740466, 0.1581057, 0.2680794, 0.40293586, 0.22712025, 0.19681138, 0.31075126])
