...
#     batch_params = ["prompt", "negative_prompt", "image_embeds", "negative_image_embeds", "image"]
...
#         expected_slice = np.array([0.5816, 0.5872, 0.4634, 0.5982, 0.4767, 0.471, 0.4669, 0.4717, 0.4966])
#         assert (
...
#             "kandinsky-community/kandinsky-2-1", paddle_dtype="float16"
#         )
...
#         expected_image = load_numpy(
#             "https://huggingface.co/datasets/hf-internal-testing/diffusers-images/resolve/main/kandinsky/kandinsky_img2img_ddpm_frog.npy"
#         )
#         init_image = load_image(
...
#         pipeline = KandinskyImg2ImgPipeline.from_pretrained(
#             "kandinsky-community/kandinsky-2-1", scheduler=scheduler, paddle_dtype="float16"
#         )
