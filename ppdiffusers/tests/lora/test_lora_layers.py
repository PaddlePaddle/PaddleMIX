...
from ppdiffusers.models.attention_processor import (  # LoRAXFormersAttnProcessor,
    Attention,
    AttnProcessor,
    AttnProcessor2_5,
    LoRAAttnProcessor,
...
class SDXLLoraLoaderMixinTests(unittest.TestCase):
    ...
    def test_load_lora_locally(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            self.assertTrue(os.path.isfile(os.path.join(tmpdirname, "paddle_lora_weights.pdparams")))
            sd_pipe.load_lora_weights(os.path.join(tmpdirname, "paddle_lora_weights.pdparams"))
