...
python infer.py --model_dir static_model/stable-video-diffusion-img2vid-xt --backend paddle --width 256 --height 256 --device gpu --task_name img2video --use_fp16 False
