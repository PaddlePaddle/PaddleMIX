...
python ../utils/test_image_diff.py --source_image ./infer_op_raw_fp16/text2img_control.png  --target_image https://paddlenlp.bj.bcebos.com/models/community/baicai/sd15_controlnet_infer_op_raw_fp16/text2img_control.png

echo "### 3.2 test_image_diff img2img"
python ../utils/test_image_diff.py --source_image ./infer_op_raw_fp16/img2img_control.png --target_image https://paddlenlp.bj.bcebos.com/models/community/baicai/sd15_controlnet_infer_op_raw_fp16/img2img_control.png
