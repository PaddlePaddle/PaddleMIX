import paddle
from ppdiffusers.transformers.clip import CLIPVisionModelWithProjection, CLIPVisionConfig
...
class MLP(paddle.nn.Layer):
    ...
    def __init__(self, in_dim, out_dim, hidden_dim, use_residual=True):
        ...
        self.fc2 = paddle.nn.Linear(in_features=hidden_dim, out_features=
            out_dim)
...
class PhotoMakerIDEncoder(CLIPVisionModelWithProjection):
    ...
    def forward(self, id_pixel_values, prompt_embeds, class_tokens_mask):
        ...
        updated_prompt_embeds = self.fuse_module(prompt_embeds, id_embeds,
            class_tokens_mask)
        return updated_prompt_embeds
