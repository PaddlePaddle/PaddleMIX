...
class ModelArguments:
    ...
    training: bool = field(default=False, metadata={"help": "Whether or not training."})
...
class DataArguments:
    ...
    dataset_path: str = field(
        default="/root/lxl/0_SC/Paddle-SC/dataset/train", metadata={"help": "The path to the dataset."}
    )
