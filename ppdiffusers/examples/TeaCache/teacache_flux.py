...
from ppdiffusers.utils import USE_PEFT_BACKEND, is_torch_version, logging, scale_lora_layers, unscale_lora_layers, recompute_use_reentrant
...
def teacache_forward(
        ...
        Args:
            ...
            joint_attention_kwargs (`dict`, *optional*):
                ...
                `self.processor` in ppdiffusers.models.attention_processor.
