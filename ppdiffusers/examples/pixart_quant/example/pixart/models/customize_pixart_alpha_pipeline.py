...
from ppdiffusers.models import AutoencoderKL, Transformer2DModel
...
from ppdiffusers.pipelines.pipeline_utils import DiffusionPipeline, ImagePipelineOutput
...
class CustomizePixArtAlphaPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        text_encoder: T5EncoderModel,
        vae: AutoencoderKL,
        transformer: CustomizeTransformer2DModel,
