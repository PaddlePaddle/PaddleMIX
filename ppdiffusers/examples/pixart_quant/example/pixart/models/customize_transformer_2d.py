...
from ppdiffusers.models.embeddings import ImagePositionalEmbeddings
...
from ppdiffusers.models.embeddings import CaptionProjection, PatchEmbed
...
from ppdiffusers.models.simplified_facebook_dit import SimplifiedFacebookDIT
...
class CustomizeTransformer2DModel(ModelMixin, ConfigMixin):
    """
