...
class ModelArguments:
    ...
    scale_factor: Optional[float] = field(
        default=0.18215, metadata={"help": "The scale factor in the first stage encoding"}
    )
    shift_factor: Optional[float] = field(default=0, metadata={"help": "The shift factor in the first stage encoding"})
    loss_type: str = field(
        default="l2", metadata={"help": "The loss type to use in training. Should be one of ['l2', 'l1']"}
    )
    # for alignmemnt
...
@dataclass
class WebVidDatasetArguments:
    """
    Parameters for dataset
    """

    train_data_root: str = field(
        default="/root/data/lvdm/webvid/share_datasets", metadata={"help": "The root path of train dataset files"}
    )
    ...
    eval_data_root: str = field(
        default="/root/data/lvdm/webvid/share_datasets", metadata={"help": "The root path of validation dataset files"}
    )
