...
class LoadTypesModel:
    def __init__(self, pipe="SG161222/RealVisXL_V3.0", vae_dir="madebyollin/sdxl-vae-fp16-fix", outputs="out_puts"):
    ...
    def switch_scheduler(self, model, scheduler_type="ddim"):
        ...
        if scheduler_type == "pndm":
            ...
            raise ValueError(
                f"Scheduler of type {scheduler_type} doesn't exist! Please choose in supported_scheduler!"
            )
