...
class StableDiffusionPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromSingleFileMixin):
    ...
    def encode_prompt(
        ...
        if text_encoder is not None:
            ...
            prompt_embeds_dtype = text_encoder.parameters()[0].dtype
        elif self.unet is not None:
            # prompt_embeds_dtype = self.unet.dtype
            prompt_embeds_dtype = self.unet.parameters()[0].dtype
        else:
    ...
    def __call__(
            ...
            for i, t in enumerate(timesteps):
                ...
                if self.infer_mode in ["fa", "paddle"]:
                    ...
                    noise_pred = self.unet(
                        ...
                        freqs_cis_img0=freqs_cis_img[0].contiguous(),
                        freqs_cis_img1=freqs_cis_img[1].contiguous(),
        ...
        if not output_type == "latent":
            ...
            image, has_nsfw_concept = self.run_safety_checker(image, None, prompt_embeds.dtype)
        else:
            image = latents
            has_nsfw_concept = None
