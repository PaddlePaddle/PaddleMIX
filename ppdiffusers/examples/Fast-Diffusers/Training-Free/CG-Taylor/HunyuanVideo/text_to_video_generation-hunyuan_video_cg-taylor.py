...
import paddle
from forwards import CGTaylor_hunyuan_forward, CGTaylor_hunyuan_pipeline
...
pipe.__class__.__call__ = CGTaylor_hunyuan_pipeline
pipe.transformer.__class__.forward = CGTaylor_hunyuan_forward
