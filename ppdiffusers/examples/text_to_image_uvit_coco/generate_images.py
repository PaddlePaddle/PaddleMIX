...
from ppdiffusers import DDIMScheduler, LDMTextToImagePipeline
...
def generate_images(
    ...
    for cfg in guidance_scales:
        ...
        for batch_prompt in tqdm(batchify(all_prompt, batch_size=batch_size)):
            ...
            paddle.seed(sd)
            batch_prompts = [x[0] for x in batch_prompt]
            images = pipe(
                batch_prompts,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        choices=["ddim"],
        help="Type of scheduler to use. Should be one of ['ddim']",
    )
