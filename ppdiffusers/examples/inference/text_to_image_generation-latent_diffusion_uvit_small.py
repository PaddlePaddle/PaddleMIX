...
from ppdiffusers import DPMSolverMultistepScheduler, LDMTextToImageUViTPipeline
...
image.save("text_to_image_generation-latent_diffusion_uvit_small-result.png")
