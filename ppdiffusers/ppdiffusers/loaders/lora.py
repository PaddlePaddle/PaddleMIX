...
class CogVideoXLoraLoaderMixin(LoraLoaderMixin):
    ...
    def lora_state_dict(
        ...
        **kwargs,
        ...
        state_dict, network_alphas, from_diffusers = super().lora_state_dict(
        ...
        is_dora_scale_present = any("dora_scale" in k for k in state_dict.keys())
    ...
    @classmethod
    def load_lora_into_transformer(
        cls, state_dict, transformer, adapter_name=None, _pipeline=None, low_cpu_mem_usage=False, from_diffusers=None
    ):
        """
        This will load the LoRA layers specified in `state_dict` into `transformer`.
        Parameters:
