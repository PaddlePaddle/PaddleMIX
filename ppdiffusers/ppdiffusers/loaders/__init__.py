...
if is_paddle_available():
    ...
    if is_paddlenlp_available():
        ...
        _import_structure["lora"] = ["LoraLoaderMixin", "StableDiffusionXLLoraLoaderMixin", "SD3LoraLoaderMixin", "FluxLoraLoaderMixin",]
...
if TYPE_CHECKING or PPDIFFUSERS_SLOW_IMPORT:
    if is_paddle_available():
        ...
        if is_paddlenlp_available():
            ...
            from .lora import FluxLoraLoaderMixin, LoraLoaderMixin, SD3LoraLoaderMixin, StableDiffusionXLLoraLoaderMixin, FluxLoraLoaderMixin
