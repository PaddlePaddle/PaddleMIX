...
class CLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from ppdiffusers.transformers import CLIPVisionConfig, CLIPVisionModel
...
class CLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from ppdiffusers.transformers import CLIPConfig, CLIPModel
    ...
    >>> from ppdiffusers.transformers import CLIPTextConfig, CLIPVisionConfig
    ...
    def __init__(
        ...
        if text_config_dict is not None:
            ...
            for key, value in _text_config_dict.items():
                if key in text_config and value != text_config[key] and key not in ["paddlenlp_version"]:
        ...
        if vision_config_dict is not None:
            ...
            for key, value in _vision_config_dict.items():
                if key in vision_config and value != vision_config[key] and key not in ["paddlenlp_version"]:
