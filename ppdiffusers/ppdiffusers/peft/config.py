...
@dataclass
class PeftConfigMixin(PushToHubMixin, SaveToAistudioMixin):
    r"""
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, subfolder: Optional[str] = None, **kwargs):
        ...
        from ppdiffusers.peft.mapping import PEFT_TYPE_TO_CONFIG_MAPPING
        ...
        download_kwargs, class_kwargs, _ = cls._split_kwargs(kwargs)
        ...
        if os.path.isfile(os.path.join(path, CONFIG_NAME)):
            ...
            try:
                config_file = bos_aistudio_hf_download(
                    pretrained_model_name_or_path, CONFIG_NAME, subfolder=subfolder, **download_kwargs
                )
            except Exception:
        ...
        # from ppdiffusers.peft import AdaLoraConfig, PeftConfig
    ...
    def _split_kwargs(cls, kwargs):
        ...
        for key, value in kwargs.items():
            if key in inspect.signature(bos_aistudio_hf_download).parameters:
        ...
        return download_kwargs, class_kwargs, other_kwargs
    ...
    def _get_peft_type(
        ...
        **download_kwargs,
        ...
        subfolder = download_kwargs.get("subfolder", None)
