...
from ppdiffusers.peft.tuners.lycoris_utils import LycorisConfig, LycorisTuner
...
class LoKrModel(LycorisTuner):
    ...
    Args:
        model (`paddle.nn.Layer`): The model to which the adapter tuner layers will be attached.
        config ([`LoKrConfig`]): The configuration of the LoKr model.
        adapter_name (`str`): The name of the adapter, defaults to `"default"`.

    Returns:
        `paddle.nn.Layer`: The LoKr model.
    ...
    **Attributes**:
    ...
    prefix: str = "lokr_"
    layers_mapping: Dict[Type[paddle.nn.Layer], Type[LoKrLayer]] = {
    ...
    def _create_and_replace(
        ...
        adapter_name: str,
        target: Union[LoKrLayer, nn.Layer],
        target_name: str,
        parent: nn.Layer,
        current_key: str,
        **optional_kwargs,
