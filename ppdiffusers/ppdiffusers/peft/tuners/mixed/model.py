...
from ppdiffusers.peft.tuners import adalora, loha, lokr, lora, oft
...
class MixedModel(BaseTuner):
    ...
    def __init__(self, model: nn.Layer, config: Configs, adapter_name: str) -> None:
    ...
    def _unload_and_optionally_merge(
        ...
        key_list = [
            key
            for key, _ in self.model.named_sublayers(include_self=True)
