...
from ppdiffusers.peft.tuners.mixed import COMPATIBLE_TUNER_TYPES
...
class PeftMixedModel(PushToHubMixin, SaveToAistudioMixin, paddle.nn.Layer):
    """
    ...
    ```py
    >>> from ppdiffusers.peft import get_peft_model

    >>> base_model = ...  # load the base model, e.g. from paddlenlp.transformers
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        # note: adapted from ppdiffusers.peftModel.from_pretrained
        ...
        # note: this is different from ppdiffusers.peftModel.from_pretrained
        ...
        # note: this is different from ppdiffusers.peftModel.from_pretrained, we always return a PeftMixedModel
