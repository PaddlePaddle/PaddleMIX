...
class StableDiffusionInstructPix2PixPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                scaled_latent_model_input = paddle.concat(x=[scaled_latent_model_input, image_latents], axis=1)
    ...
    def _encode_prompt(
        ...
        if do_classifier_free_guidance:
            ...
            prompt_embeds = paddle.concat(x=[prompt_embeds, negative_prompt_embeds, negative_prompt_embeds])
