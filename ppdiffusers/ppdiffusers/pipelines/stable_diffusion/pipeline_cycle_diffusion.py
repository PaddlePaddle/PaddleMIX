...
class CycleDiffusionPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def __call__(
        ...
        source_prompt_embeds_tuple = self.encode_prompt(
            source_prompt, num_images_per_prompt, do_classifier_free_guidance, None, clip_skip=clip_skip
        )
        ...
        if source_prompt_embeds_tuple[1] is not None:
            source_prompt_embeds = paddle.concat([source_prompt_embeds_tuple[1], source_prompt_embeds_tuple[0]])
        else:
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                source_latent_model_input = (
                    paddle.concat([source_latents] * 2) if do_classifier_free_guidance else source_latents
                )
                ...
                if do_classifier_free_guidance:
                    ...
                    (source_noise_pred, noise_pred) = concat_noise_pred.chunk(2, axis=0)
