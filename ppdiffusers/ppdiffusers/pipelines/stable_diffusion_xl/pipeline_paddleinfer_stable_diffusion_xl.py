...
# Copyright 2023 The Hugg gFace Team. All rights reserved.
#
...
from .paddleinferxl_utils import PaddleInferDiffusionXLPipelineMixin
...
class PaddleInferStableDiffusionXLPipeline(DiffusionPipeline, PaddleInferDiffusionXLPipelineMixin):
    """
    ...
    def __init__(
        self,
        vae_encoder: PaddleInferModel,
        vae_decoder: PaddleInferModel,
        text_encoder: PaddleInferModel,
        text_encoder_2: PaddleInferModel,
        tokenizer: paddlenlp.transformers.CLIPTokenizer,
        tokenizer_2: paddlenlp.transformers.CLIPTokenizer,
        unet: PaddleInferModel,
