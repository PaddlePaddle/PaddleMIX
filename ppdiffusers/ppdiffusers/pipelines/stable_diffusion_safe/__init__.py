...
from ...utils import BaseOutput, OptionalDependencyNotAvailable, is_paddle_available, is_transformers_available
...
try:
    ...
    from ...utils.dummy_paddle_and_transformers_objects import *
else:
