...
class HunyuanVideoPipeline(DiffusionPipeline):  # HunyuanVideoLoraLoaderMixin
    ...
    def _get_llama_prompt_embeds(
        ...
        if crop_start is None:
            ...
            crop_start = tuple(prompt_template_input["input_ids"].shape)[-1]
        ...
        prompt_attention_mask = prompt_attention_mask.tile(repeat_times=[1, num_videos_per_prompt])
    ...
    def _get_clip_prompt_embeds(
        ...
        # duplicate text embeddings for each generation per prompt, using mps friendly method
        prompt_embeds = prompt_embeds.tile(repeat_times=[1, num_videos_per_prompt])
