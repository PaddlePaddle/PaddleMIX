...
class FluxControlNetInpaintPipeline(
    ...
    Args:
        ...
        tokenizer_2 (`T5Tokenizer`): Tokenizer for the T5 text model.
    """
    ...
    def __call__(
        ...
        Args:
            ...
            mask_image (`PIL.Image.Image` or `List[PIL.Image.Image]` or `paddle.Tensor`):
                The mask image(s) to use for inpainting. White pixels in the mask will be repainted, while black pixels
                will be preserved.
            masked_image_latents (`paddle.Tensor`, *optional*):
