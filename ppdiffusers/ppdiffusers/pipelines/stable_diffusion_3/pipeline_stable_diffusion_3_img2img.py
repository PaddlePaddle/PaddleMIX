...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> pipe = AutoPipelineForImage2Image.from_pretrained(model_id_or_path, paddle_dtype=paddle.float16)
...
class StableDiffusion3Img2ImgPipeline(DiffusionPipeline):
    ...
    def prepare_latents(self, image, timestep, batch_size, num_images_per_prompt, dtype, generator=None):
        ...
        latents = init_latents.cast(dtype=dtype)
    ...
    def __call__(
        ...
        latent_timestep = timesteps[:1].tile([batch_size * num_inference_steps])
