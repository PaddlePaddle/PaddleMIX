...
class ShapEPipeline(DiffusionPipeline):
    ...
    def _encode_prompt(self, prompt, num_images_per_prompt, do_classifier_free_guidance):
        ...
        prompt_embeds = prompt_embeds / paddle.linalg.norm(x=prompt_embeds, axis=-1, keepdim=True)
    ...
    def __call__(
        ...
        latents = self.prepare_latents(
            (batch_size, num_embeddings * embedding_dim), prompt_embeds.dtype, generator, latents, self.scheduler
        )
        ...
        for i, t in enumerate(self.progress_bar(timesteps)):
            ...
            noise_pred = self.prior(
                scaled_model_input, timestep=t, proj_embedding=prompt_embeds
