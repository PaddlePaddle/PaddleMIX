...
try:
    ...
    _dummy_modules.update(get_objects_from_module(dummy_paddle_objects))

else:
    _import_structure["preconfig"] = ["PreconfigEulerAncestralDiscreteScheduler", "PreconfigLMSDiscreteScheduler"]
...
try:
    ...
    _dummy_modules.update(get_objects_from_module(dummy_paddle_and_scipy_objects))
...
try:
    ...
    _dummy_modules.update(get_objects_from_module(dummy_paddle_and_paddlesde_objects))
