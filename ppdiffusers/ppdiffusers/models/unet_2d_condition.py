...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        if (self.data_format == "NCHW" and any(s % default_overall_up_factor != 0 for s in sample.shape[-2:])) or (self.data_format == "NHWC" and (sample.shape[1] % default_overall_up_factor != 0 or sample.shape[2] % default_overall_up_factor != 0)):
