...
class UViTModel_T2I(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        encoder_hidden_states = encoder_hidden_states.cast(self.dtype)
        ...
        time_token = get_timestep_embedding(timestep, self.embed_dim, True, 0).unsqueeze(axis=1)
        context_token = self.context_embed(encoder_hidden_states)
