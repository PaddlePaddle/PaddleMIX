...
class PriorTransformer(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        if encoder_hid_proj_type is None:
            ...
            self.encoder_hidden_states_proj = nn.Linear(embedding_dim,
                                                        inner_dim)
        else:
            raise ValueError(
    ...
    def forward(
        ...
        additional_embeddings_len = additional_embeddings_len + proj_embeddings.shape[
            1] + 1
        if positional_embeddings.shape[1] < hidden_states.shape[1]:
            positional_embeddings = F.pad(
                ...
                (
                    ...
                    if self.prd_embedding is not None else 0, ),
                value=0.0,
                data_format="NLC", )
