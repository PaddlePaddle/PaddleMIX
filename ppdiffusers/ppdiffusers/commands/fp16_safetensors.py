...
"""
Usage example:
    ppdiffusers-cli fp16_safetensors --ckpt_id=openai/shap-e --fp16 --use_safetensors
"""
...
class FP16SafetensorsCommand(BasePPDiffusersCLICommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        conversion_parser.add_argument(
            "--to_diffusers",
            action="store_true",
            help="When or not save as diffusers dataformat.",
        )
        conversion_parser.set_defaults(func=conversion_command_factory)

    def __init__(self, ckpt_id: str, fp16: bool, use_safetensors: bool, use_auth_token: bool):
        self.logger = logging.get_logger("ppdiffusers-cli/fp16_safetensors")
    ...
    def run(self):
        ...
        pipeline = pipeline_class.from_pretrained(
            self.ckpt_id,
            paddle_dtype=paddle.float16 if self.fp16 else paddle.float32,
        ...
        # Open the PR.
        commit_description = (
            "Variables converted by the [`ppdiffusers`' `fp16_safetensors`"
            " CLI](https://github.com/PaddlePaddle/PaddleMIX/blob/develop/ppdiffusers/ppdiffusers/commands/fp16_safetensors.py)."
        )
