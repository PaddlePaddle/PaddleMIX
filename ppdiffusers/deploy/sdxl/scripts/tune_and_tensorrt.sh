...
python infer.py --model_dir static_model/stable-diffusion-xl-base-1.0 --scheduler "ddim" --backend paddle --device gpu --task_name all --width 512 --height 512 --inference_steps 50 --tune True --use_fp16 False
