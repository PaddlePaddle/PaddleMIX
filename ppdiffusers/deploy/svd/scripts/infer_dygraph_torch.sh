...
python infer_dygraph_torch.py --model_dir stabilityai/stable-video-diffusion-img2vid-xt --scheduler "euler" --backend paddle --width 256 --height 256 --device gpu --task_name img2video --inference_steps 25