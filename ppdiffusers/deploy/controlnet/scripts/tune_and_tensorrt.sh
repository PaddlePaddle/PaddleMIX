...
python infer.py --model_dir static_model/stable-diffusion-v1-5-canny/ --scheduler "euler" --backend paddle_tensorrt --device gpu --task_name all --width 512 --height 512 --inference_steps 50 --benchmark_steps 10
