...
import paddle
from paddleinfer_stable_diffusion_xl_housing import (
...
from ppdiffusers import PaddleInferRuntimeModel, StableDiffusionXLPipeline
...
def convert_ppdiffusers_pipeline_to_paddleinfer_pipeline(
    ...
    fd_pipe_cls = PaddleInferStableDiffusionXLPipelineHousing
