...
class Predictor(object):
    ...
    def predict(self, images, text, prompt=None):
        ...
        pixel_values = paddle.to_tensor(npzfile["language_model_inputs"])
        second_input_ids = paddle.to_tensor(npzfile["input_ids"])
        pixel_values = paddle.tile(pixel_values, repeat_times=[batch, 1, 1, 1])
        second_input_ids = paddle.tile(second_input_ids, repeat_times=[batch, 1])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--second_model_path",
        default="/zhoukangkang/2023-06-06minigpt/whole_part/opt-2.7b-kaiyuan/opt",
        type=str,
        help="",
    )
    ...
    print("Reference: of two cats laying on a pink blanket.")
    print("Outputs: ", msg)
    print("infer OK")
