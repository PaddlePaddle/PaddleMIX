...
def parse_arguments():
    ...
    parser.add_argument(
        "--video_file", default="paddlemix/demo_images/red-panda.mp4", help="Path to the input video file."
    )
    parser.add_argument("--question", default="What are in this video?", help="Input question text for the model.")
    parser.add_argument(
        "--output_audio_file", type=str, default="video_output.wav", help="Path to save the output audio file."
    )
