...
[CoCa](https://arxiv.org/abs/2205.01917): Contrastive Captioners are Image-Text Foundation Models, Paddle实现版本.
...
3）安装`FusedLayerNorm`，在`paddlemix/external_ops/`目录下，安装fusedln包。(CoCa模型可选)
