...
from paddlemix.models.llava_next.mm_utils import get_model_name_from_path, load_image, is_valid_video_filename
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-file", type=str, nargs='+', required=True, help="Path to an image file or a list of image files.")
