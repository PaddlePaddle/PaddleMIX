...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model_size", type=str, default="3B", choices=["3B", "7B"], help="Model size, can be 3B or 7B"
    )
    parser.add_argument(
        "--src_dir",
        type=str,
        default="torch_models/Qwen2.5-VL-3B-Instruct",
    ...
    parser.add_argument(
        "--dest_dir",
        type=str,
        default="paddle_models/Qwen2.5-VL-3B-Instruct",
