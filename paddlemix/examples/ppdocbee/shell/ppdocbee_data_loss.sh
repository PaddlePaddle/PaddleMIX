...
MASTER='127.0.0.1:8083'

meta_path="/root/paddlejob/hk0/git/PaddleMIX/paddlemix/examples/ppdocbee/configs/ppdata_chart_en.json"
...
python paddlemix/examples/ppdocbee/ppdocbee_finetune_data_off.py \
  --do_train \
  ...
  2>&1 | tee -a "data_loss_ppdata_charten.txt"
