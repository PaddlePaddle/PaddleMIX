...
from .timm_transforms import RandomResizedCropAndInterpolation, ToNumpy
...
def transforms_imagenet_train(
    ...
    if use_prefetcher:
        ...
        # if re_prob > 0.: # default 0.
        #     final_tfl.append(
        #         transforms.RandomErasing( # paddle diff
        #             re_prob,
        #             mode=re_mode,
        #             max_count=re_count,
        #             num_splits=re_num_splits))
        # transforms.RandomErasing(prob=0.5, scale=(0.02, 0.33), ratio=(0.3, 3.3), value=0, inplace=False, keys=None)
...
def create_transform(
        ...
        color_jitter=0.4,
        auto_augment=None,
        interpolation='bilinear',  # bicubic default
        mean=IMAGENET_DEFAULT_MEAN,
        std=IMAGENET_DEFAULT_STD,
        re_prob=0.,
        re_mode='const',
