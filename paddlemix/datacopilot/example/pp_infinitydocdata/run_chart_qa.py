...
def main(chart_dir, ori_chart_dir, table_dir, max_workers, config, model_name):
    ...
    for chart_type in chart_type_list:
        ...
        args_list = [
            ...
            if not os.path.exists(os.path.join(save_dir, f"{os.path.splitext(chart_name)[0]}.json"))
        ]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default="chart_output.json")
    ...
    main(
        ...
        ori_chart_dir=args.chart_dir,
        table_dir=args.chart_dir,
