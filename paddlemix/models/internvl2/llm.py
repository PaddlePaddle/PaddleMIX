...
try:
    ...
    from paddle.nn.functional.flash_attention import flash_attn_unpadded as _flash_attn_varlen_func
...
class InternLM2Attention(paddle.nn.Layer):
    ...
    def forward(
        ...
        **kwargs
        ...
        attn_weights = paddle.nn.functional.softmax(x=attn_weights, axis=-1, dtype="float32").astype(query_states.dtype)
    ...
    def _flash_attention_forward(
        ...
        if attention_mask is not None:
            ...
            attn_output = flash_attn_func(
                query_states, key_states, value_states, dropout, causal=causal
            )
